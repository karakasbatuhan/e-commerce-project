export default function CategoryPick() {
    return (
        <div className="bg-[#FAFAFA] w-full h-[768px] max-2xl:h-[1850px] font-montserrat flex flex-col justify-center items-center gap-10 overflow-hidden">
            ...
            <div className="flex gap-9 max-2xl:flex-col">
                <div className="bg-[url(./assets/category-1.jpg)] flex items-end bg-cover bg-center w-[33.3rem] h-[31.3rem] max-2xl:w-[323px]">
                ...
                <div className="bg-[url(./assets/category-2.jpg)] flex items-end bg-cover bg-center w-[15rem] h-[31.3rem] max-2xl:w-[323px]">
                ...
                <div className="flex flex-col gap-5.5">
                    <div className="bg-[url(./assets/category-3.jpg)] flex items-end bg-cover bg-center w-[15rem] h-60 max-2xl:w-[323px]">
                    ...
                    <div className="bg-[url(./assets/category-4.jpg)] flex items-end bg-cover bg-center w-[15rem] h-60 max-2xl:w-[323px]">
