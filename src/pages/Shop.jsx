    ...
    return (
            <div className="flex flex-col font-montserrat">
                <div className="flex flex-col text-[#252B42] bg-[#FAFAFA] pb-12">
                    <div className="flex flex-row h-[92px] justify-around items-center">
                    ...
                    <div className="flex flex-row items-center justify-center gap-5">
                        <div className="bg-[url('/src/assets/shop-bg.jpg')] bg-cover bg-center leading-6 text-white tracking-widest cursor-pointer">
                            <div className="flex flex-col items-center justify-center w-[204px] h-[223px] backdrop-brightness-80">
                    ...
                    <div className="flex flex-row h-[98px] justify-center gap-70 items-center">
                ...
                <div className="mt-15 flex flex-col h-[1778px] items-center gap-15 mb-50">
                    <div className="flex flex-row gap-5">
                        <ProductCard />
                        <ProductCard />
                        <ProductCard />
                ...
                <div className="h-[175px] bg-[#FAFAFA] flex flex-row justify-center items-center">
